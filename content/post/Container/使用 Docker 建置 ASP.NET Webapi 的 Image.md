...
雖然在 [Docker 操作簡介]({{< ref "../Series/build-automated-deploy/Docker%20操作簡介.md" >}}) 已經有提過，不過還是簡單回顧一下。
...
![Multi-Stage 建置 Image 的訊息](../../images/aspnet-containerized/docker-multi-stage-build.png)

![傳入的 Argument 確實的被程式取得](../../images/aspnet-containerized/docker-run-args.png)
...
![快速驗證檔案加入 Volume 的流程](../../images/aspnet-containerized/docker-volume-add-file.png)
...
![使用 docker inspect 查詢 container 的 IP address](../../images/aspnet-containerized/docker-inspect-network-ip.png)
...
- [Docker 操作簡介]({{< ref "../Series/build-automated-deploy/Docker%20操作簡介.md" >}})
- [使用 dotnet-ef 建立 PostgreSQL 的 DBContext]({{< ref "../Develop/使用%20dotnet-ef%20建立%20PostgreSQL%20的%20DBContext.md" >}})
- [使用 dotnet-ef 建立 SQL Server on Docker 的 DBContext]({{< ref "../Develop/使用%20dotnet-ef%20建立%20SQL%20Server%20on%20Docker%20的%20DBContext.md" >}})
