...
![單台機器架構](../../../images/architecture-cloud-01/images/single_machine_v3.png)
...
![單台機器的雲端架構](../../../images/architecture-cloud-01/images/single_machine_aws_archtiecture_v2.png)
...
![AZ](../../../images/architecture-cloud-01/images/az-datacenter.png)
...
![AZ](../../../images/architecture-cloud-01/images/az.png)
圖片來源: [Youtube: AWS Global Cloud Infrastructure](https://www.youtube.com/watch?v=RPis5mbM8c8)
...
![internet-gateway](../../../images/architecture-cloud-01/images/internet-gateway-basics.png)
...
![route](../../../images/architecture-cloud-01/images/route-table.png)
圖示來源: [AWS](https://docs.aws.amazon.com/vpc/latest/userguide/how-it-works.html)

##### Network Access Control List, NACL

屬於 [OSI Level 4: Transport Layer]({{< ref "../../Security/談%20HTTPS%20與%20SSL-TLS%20的關係.md" >}}) 層級的操作，如同防火牆一般，可控制一或多個 subnet 的傳入和傳出流量。
...
因為可依據協定和連接埠編號控制流量，應屬於 OSI Level 3: Network Layer / [OSI Level 4: Transport Layer]({{< ref "../../Security/談%20HTTPS%20與%20SSL-TLS%20的關係.md" >}}) 層級的操作。([參考來源](https://stackoverflow.com/questions/65507894/at-what-osi-layer-do-aws-security-groups-operate))
...
![sg_vs_nacl](../../../images/architecture-cloud-01/images/security-diagram_updated.png)
...
![role](../../../images/architecture-cloud-01/images/role.png)
...
![iam-intro-users-and-groups](../../../images/architecture-cloud-01/images/iam-intro-users-and-groups.diagram.png)
圖示來源: [AWS](https://docs.aws.amazon.com/vpc/latest/userguide/how-it-works.html)
...
![EBS 運作方式](../../../images/architecture-cloud-01/images/Product-Page-Diagram_Amazon-Elastic-Block-Store.png)
