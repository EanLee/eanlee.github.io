...
![GitHub 首頁(2018)](../../../images/series-build-automated-deploy/remote-repository/github-index-2018.png)

![GitHub 首頁(2023)](../../../images/series-build-automated-deploy/remote-repository/github-index-2023.png)
...
![GitHub 建立新 Repository 的進入點](../../../images/series-build-automated-deploy/remote-repository/github-new-repository.png)

![GitHub 建立 Repository 必須資訊](../../../images/series-build-automated-deploy/remote-repository/github-create-repository.png)
...
![GitHub Repository 建立完成](../../../images/series-build-automated-deploy/remote-repository/github-empty-repository.png)
...
![BitBucket index in 2019](../../../images/series-build-automated-deploy/remote-repository/bitbucket-index-in-2019.png)

![BitBucket Index in 2023](../../../images/series-build-automated-deploy/remote-repository/bitbucket-index-in-2023.png)
...
![可選擇的新增項目](../../../images/series-build-automated-deploy/remote-repository/bitbucket-create-option.png)

當按下 `Create` ，並選取 `Respository` 後，會看到設定 repository 的設定畫面。

![建立 Repository 必填資訊](../../../images/series-build-automated-deploy/remote-repository/bitbucket-create-repository.png)
...
![建立完成的畫面](../../../images/series-build-automated-deploy/remote-repository/bitbucket-created-repository.jpeg)
...
![Repository 的設定畫面](../../../images/series-build-automated-deploy/remote-repository/bitbucket-repository-setting.jpeg)
...
![2019 年 Azure DevOps 定價](../../../images/series-build-automated-deploy/remote-repository/azure-devops-charge-2019.png)

![2023 年 Azure DevOps 定價](../../../images/series-build-automated-deploy/remote-repository/azure-devops-charge-2023.jpeg)
...
![Azure DevOps Ad](../../../images/series-build-automated-deploy/remote-repository/azure-devops-ad.png)
...
![Azure Dashboard](../../../images/series-build-automated-deploy/remote-repository/azure-dashboard.png)

![Azure DevOps organizations](../../../images/series-build-automated-deploy/remote-repository/azure-devops-organizations.png)
...
![Azure Devops Organization list](../../../images/series-build-automated-deploy/remote-repository/azure-devops-organization-list.png)

若是沒有任何所屬組織，會要求用戶新增一個組織並建立新專案。

![create organization](../../../images/series-build-automated-deploy/remote-repository/azure-devops-organization-create.png)
...
![在 Azure Devops 建立新專案的畫面 (2019 年)](../../../images/series-build-automated-deploy/remote-repository/azure-devops-create-project.png)

![在 Azure Devops 建立新專案的畫面 (2023 年)](../../../images/series-build-automated-deploy/remote-repository/azure-devops-create-project-2023.png)

專案建立後，會在左側功能看到 Azure DevOps 提供的服務，像 `Boards`、`Repos`、`Pipeline`、`Test Plan`。

![Azure Devops 的專案畫面](../../../images/series-build-automated-deploy/remote-repository/azure-devops-project-index.png)

點開 `Repos` 後，會發現系統己經自行建立一個與專案名稱相同的 Repository。也一樣會貼心的提示您，如何將本地端的 repository 與 BitBucket repository 建立起關連。

![空白專案的操作方式](../../../images/series-build-automated-deploy/remote-repository/azure-devops-created.png)

如果需要額外進行 Repository 的新增、滙入與合併，可以直接點選頁面上方的 repository 項目，就會出現操作選單。

![Repository 的延伸操作](../../../images/series-build-automated-deploy/remote-repository/azure-devops-repos-manage.png)
