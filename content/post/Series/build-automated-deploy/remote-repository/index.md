...
Eric: 通常，我們習慣將提供 Remote Repository 服務的平台，稱為 **程式碼托管平台**。而提到托管平台，一定會有 GitHub 的身影。GitHub 是目前最大的 open source 的集散地。就連 Microsoft 都將部份產品的程式碼儲存在這。提供給社群內的人們有參與專案的機會。
...
Eric: 我們直接進到 [GitHub](https://github.com/) 的首頁，就會看到它的宣言了。

---

![GitHub Index for 2018](images/github-index-2018.png)

📝 2023 年的 GitHub 首頁的宣言已更換，GitHub 將自己定位為安全的協作平台。
...
其實，只要設定完成 **Repository name** 資料，按下 `Create repository` 就完成 了。
...
📝在 2019 年，GitHub 宣佈提供 private repositories 給免費用戶，但 private repositoryes 有著最多三位共同開發者的限制。



![create_repository_after](images/github-empty-repository.png)

建立 repository 完成後，也很貼心的提示您，本地端的 repository 要如何與  GitHub repository 建立起關連。
...
```chat
Eric: 說完了 GitHub、BitBucket ，最後，來了解一下 Microsoft 所推出的 **[Azure DevOps](https://azure.microsoft.com/en-us/services/devops/)** 。
吉米: Azure DevOps？
...
![charge](images/azure-devops-charge-2019.png)
