...
> [2019 iT 邦幫忙鐵人賽](https://ithelp.ithome.com.tw/users/20107551/ironman/1906)文章補完計劃，[從零開始建立自動化發佈的流水線]({{< ref "從零開始建立自動化發佈的流水線.md" >}}) 持續整合篇
...
![Travis CI 執行結果](../../../images/series-build-automated-deploy/ci-automated-unit-test/travisCI_result.png)
...
![Azure Pipleline](../../../images/series-build-automated-deploy/ci-automated-unit-test/Azure_pipleline_log.jpeg)

除了單元測試以外，還想加入其他的測試計劃，可以選擇 `Test Plans`。這部份就不多加著墨，有興趣可以自行摸索。

![Azure Test Plan](../../../images/series-build-automated-deploy/ci-automated-unit-test/TestPlan.jpeg)
