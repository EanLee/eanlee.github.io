...
> [2019 iT 邦幫忙鐵人賽](https://ithelp.ithome.com.tw/users/20107551/ironman/1906)文章補完計劃，[從零開始建立自動化發佈的流水線]({{< ref "從零開始建立自動化發佈的流水線.md#container" >}})tainer 篇

在上一篇  [使用 Container 建立 CI 所需要的建置環境]({{< ref "../../../Post/Series/build-automated-deploy/使用%20Container%20建立%20CI%20所需要的建置環境.md" >}}) 中，初步了解如何在 Travis CI、Azure DevOps、Jenkins 中，使用 Docker 來建立 CI 運行 Build、Test 所需的環境。
...
![建立新的 Pipeline](azure_pipeline_new_pipeline.png)

![設定 Azure Pipleline 組態](azure_pipeline_new_pipeline_select_docker.png)

![選擇使用 Docker](azure_pipeline_dockerfile.png)

![自動產出的 azure-pipeline.yml 檔](azure_pipeline_review.png)
