...
![Dropbox-Uploader by andreafabrizi GitHub](../../../images/series-build-automated-deploy/cd-dropbox/dropbox-uploader-github.png)

首先，先到 [Dorpbox Developers](https://www.dropbox.com/developers)，會看到以下的畫面

![2023 年 Dropbox Developer 首頁](../../../images/series-build-automated-deploy/cd-dropbox/dropbox-developer-index.png)

在成功註冊/登入後，首先，我們必須在 `Dropbox` 建立 app 專案，讓 Dropbx 開放權限，允許應用程式呼叫 Dropbox API。

![應用程式控制台 (2018)](../../../images/series-build-automated-deploy/cd-dropbox/dropbox-developer-app-console-2018.png)

![應用程式控制台 (2023)](../../../images/series-build-automated-deploy/cd-dropbox/dropbox-developer-app-console-2023.png)
...
![建立 Dropbox app (2018)](../../../images/series-build-automated-deploy/cd-dropbox/dropbox-developer-create-app-2018.jpeg)

![建立 Dropbox app (2023)](../../../images/series-build-automated-deploy/cd-dropbox/dropbox-developer-create-app-2023.png)

完成建立後，直接到 `OAuth 2` 的區域取得 Token 值，這會用在 `Dropbox_Uploader.sh` 之中。

![Dropbox app 的組態設定畫面 (2018)](../../../images/series-build-automated-deploy/cd-dropbox/dropbox-app-config.jpeg)
...
![使用 Travis CI 把檔案發佈到 Dropbox](../../../images/series-build-automated-deploy/cd-dropbox/dropbox-list-on-travis.jpeg)
...
![使用 Azure Pipeline 把檔案發佈到 Dropbox](../../../images/series-build-automated-deploy/cd-dropbox/dropbox-list-on-azure-devops.jpeg)
