---
title: 不再做白工！軟體開發需求釐清的關鍵技巧與溝通心法
description: 面對頻繁變更的軟體需求，如何避免做白工？整理從問題根源挖掘、使用者情境拆解到規格確認的實務溝通框架，分享如何拉近工程端與業務端的認知距離，打造能真正解決問題的軟體產品。
...
雖然，無法精確知道專案開發內，所有可能會遭遇到的難題或卡點，卻可以藉由啟動前的盤點與分析，嘗試看見全貌，提前鎖定需求或作法不明確的範圍，提早知道可能遇到的瓶頸，限定問題發生範圍。
...
與其這樣，倒不如一開發就讓團隊，針對要開發的需求有所共識，雖然可能會比較晚切入開發進度，但卻可有效減少後期的異常成本。
...
這階段就算沒有完全正確也沒關係，但至少藉由這個方式，對於開發的全盤有一個概括的理解，就算後續有所異動，也可以快速的找出相關的區域與範圍。
...
💬 **參與討論**
「與其無腦寫 Code，不如先搞懂客戶到底痛在哪裡！」你在專案中遇過最離譜的需求變更是什麼？最後團隊是怎麼釐清與解決的？來留言區分享你的求生血淚史！
